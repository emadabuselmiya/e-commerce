                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <textarea class="form-control input-md" placeholder="Description ..."
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="number" placeholder="Sale Price" class="form-control input-md"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="file" class="inputfile" wire:model="newimage">
                                    @if ($newimage)
