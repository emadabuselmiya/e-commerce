            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" wire:submit.prevent="addSlide()" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Slide Image</label>
                                <div class="col-md-4">
                                    <input type="file" class="inputfile" wire:model="image">
                                    @if ($image)
